...
admin.site.site_header = "Josh"
admin.site.site_title = "Josh Admin Portal"
admin.site.index_title = "Josh Admin"

# swagger
api_info = openapi.Info(
    title="Josh API",
    default_version="v1",
    description="API documentation for Josh App",
)
